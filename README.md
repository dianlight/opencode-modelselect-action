...
> Last updated: **2026-09-06 08:09 UTC**.
...
|-----------|-------------|----------|-----------|---------|
| `Plan` | Planning, architecture decisions, task decomposition | `opencode/gpt-5-codex` (96.1, $1.07/$8.5) | `opencode/nemotron-3-ultra-free` (75.6, Free) | 🏆 `opencode-go/deepseek-v4-flash-vision-exp` (86.1, $0.14/$0.28) |
| `Ask` | General Q&A, explanations, analysis | `opencode/gpt-5.5-pro` (81.6, $30/$180) | `opencode/nemotron-3-ultra-free` (74.0, Free) | 🏆 `opencode-go/nemotron-3-ultra-free` (74.0, Free) |
| `Code` | Code generation, implementation, refactoring | `opencode/claude-fable-5-1` (74.2, $10/$50) | `opencode/big-pickle` (67.0, Free) | 🏆 `opencode-go/big-pickle` (67.0, Free) |
| `issue-triage` | Triage, label, categorize, route issues | `opencode/gpt-5.5-pro` (81.6, $30/$180) | `opencode/nemotron-3-ultra-free` (74.0, Free) | 🏆 `opencode-go/nemotron-3-ultra-free` (74.0, Free) |
| `issue-implementation` | Implement, fix, resolve issues | `opencode/claude-fable-5-1` (74.2, $10/$50) | `opencode/big-pickle` (67.0, Free) | 🏆 `opencode-go/big-pickle` (67.0, Free) |
| `pr-review` | Review PRs, pull requests, diffs | `opencode/gpt-5-codex` (96.1, $1.07/$8.5) | `opencode/nemotron-3-ultra-free` (75.6, Free) | 🏆 `opencode-go/deepseek-v4-flash-vision-exp` (86.1, $0.14/$0.28) |
| `code-implementation` | Generate code, refactor, implement features | `opencode/claude-fable-5-1` (74.2, $10/$50) | `opencode/big-pickle` (67.0, Free) | 🏆 `opencode-go/big-pickle` (67.0, Free) |
| `frontend-design` | UI design, components, layouts, mockups | `opencode/gpt-6-astra` (86.3, $10/$50) | `opencode/mimo-v2.5-free` (54.0, Free) | 🏆 `opencode-go/kimi-k3` (72.6, $3/$15) |
| `frontend-testing` | Playwright, Cypress, E2E, frontend tests | `opencode/claude-fable-5-1` (74.2, $10/$50) | `opencode/big-pickle` (67.0, Free) | 🏆 `opencode-go/big-pickle` (67.0, Free) |
| `api-testing` | API testing, integration tests, OpenAPI, Postman | `opencode/claude-fable-5-1` (74.2, $10/$50) | `opencode/big-pickle` (67.0, Free) | 🏆 `opencode-go/big-pickle` (67.0, Free) |
| `other` | Everything else | `opencode/claude-fable-5-1` (83.8, $10/$50) | `opencode/nemotron-3-ultra-free` (68.7, Free) | 🏆 `opencode-go/deepseek-v4-flash-vision-exp` (77.7, $0.14/$0.28) |
...
| `nemotron-3.5-lightning-free` | Free | ❌ Missing | — | — | — | — | — | — | Free | Free | Free | — |
...
> Audited: **2026-09-06 08:09 UTC**
> Workflows checked: **1**
> OpenCode steps found: **1**

| Workflow | Job | Step | Task Type | Current Model | Recommended Zen | Recommended Free | Recommended Go | Status |
|----------|-----|------|-----------|---------------|-----------------|------------------|----------------|--------|
| `OpenCode Maintenance` | `Handle Checked Tasks` | `Run OpenCode for checked tasks` | `code-implementation` | `opencode/big-pickle` (`/ocf`: `opencode/big-pickle`) ⚙️ | `opencode/claude-fable-5-1` (74.2 (+11%), $10/$50) | 🏆 `opencode/big-pickle` (67.0, Free) | `opencode-go/big-pickle` (67.0, Free) | ✅ |
