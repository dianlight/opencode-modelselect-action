...
> Last updated: **2026-09-06 10:21 UTC**.
...
| `issue-triage` (Issue Triage) | Triage, label, categorize, route issues | `opencode/gpt-5.5-pro` (81.6, $30/$180) | `opencode/muse-spark-1.3-contributor-free` (78.9, Free) | 🏆 `opencode-go/longcat-2.0` (85.0) |
...
| `ui-design` (UI Design) | UI design, components, layouts, mockups | `opencode/gpt-6-astra` (86.3, $10/$50) | `opencode/muse-spark-1.3-contributor-free` (68.4, Free) | 🏆 `opencode-go/hy4-preview` (84.0) |
...
| `docs` (Docs) | Documentation, READMEs, changelogs, docstrings | `opencode/gpt-5.5-pro` (81.6, $30/$180) | `opencode/muse-spark-1.3-contributor-free` (78.9, Free) | 🏆 `opencode-go/longcat-2.0` (85.0) |
...
| `generic` (Generic) | General Q&A, explanations, analysis, everything else | `opencode/gpt-5.5-pro` (81.6, $30/$180) | `opencode/muse-spark-1.3-contributor-free` (78.9, Free) | 🏆 `opencode-go/longcat-2.0` (85.0) |
...
| `longcat-2.0` | Go (Paid) | 📋 Fallback | Plan, Triage | 60.0 | 70.0 | 85.0 | 40.0 | 85.0 | — | — | — | — |
...
| `mimo-v2.5` | Go (Paid) | 📋 Fallback | Triage, Docs | 62.0 | 60.0 | 64.0 | 58.0 | 65.0 | — | — | — | — |
| `mimo-v2.5-free` | Free | 📋 Fallback | Triage, Docs | 58.0 | 56.0 | 60.0 | 54.0 | 62.0 | Free | Free | Free | — |
| `mimo-v2.5-pro` | Go (Paid) | 📋 Fallback | Triage, Docs | 68.0 | 66.0 | 70.0 | 55.0 | 74.0 | — | — | — | — |
...
| `qwen3.7-plus` | Go (Paid) | 📋 Fallback | Plan, Triage | 66.0 | 62.0 | 72.0 | 62.0 | 72.0 | — | — | — | — |
...
> Audited: **2026-09-06 10:21 UTC**
> Workflows checked: **1**
> OpenCode steps found: **1**

| Workflow | Job | Step | Task Type | Current Model | Recommended Zen | Recommended Free | Recommended Go | Status |
|----------|-----|------|-----------|---------------|-----------------|------------------|----------------|--------|
| `OpenCode Maintenance` | `Handle Checked Tasks` | `Run OpenCode for checked tasks` | `code` | `opencode/big-pickle` (`free`: `opencode/big-pickle`) ⚙️ | `opencode/claude-fable-5-1` (74.2 (+11%), $10/$50) | 🏆 `opencode/muse-spark-1.3-contributor-free` (70.9, Free) | `opencode-go/muse-spark-1.3-contributor-free` (70.9, Free) | ⚠️ |
